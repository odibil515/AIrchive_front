...
const agents: Agent[] = [
  ...
  },
  {
    ...
    description:
      "Specialized in predicting gold price movements based on economic indicators and market sentiment.",
    creator: "gold_trader",
    price: 0.06,
    performance: 7.8,
    rating: 3.8,
  ...
  },
  {
    ...
    description:
      "This agent analyzes tech stocks based on earnings reports, news sentiment, and technical indicators.",
    creator: "stock_guru",
    price: 0.1,
    performance: 15.2,
    rating: 4.7,
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-400">
              Discover and Subscribe AI trading agents
            </p>
          </div>
        </div>
